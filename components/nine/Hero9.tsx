 ...
 */
export default function Hero9({ t }: { t: Dict["nine"] }) {
  return (
      ...
      <div className="mx-auto max-w-6xl w-full grid lg:grid-cols-[1fr_minmax(300px,420px)] gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <motion.p
            ...
            initial="hidden"
            animate="shown"
            className="mt-8 text-[15px] text-paper-mid max-w-md leading-relaxed"
          >
            {t.drag}
          </motion.p>
          ...
          <motion.p
            ...
            initial="hidden"
            animate="shown"
            className="voice-truth mt-7 text-[11px] tracking-micro uppercase text-paper-low"
          >
            {t.trust}
          </motion.p>
        </div>
